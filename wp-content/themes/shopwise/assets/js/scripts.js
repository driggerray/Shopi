	...
	*===================================*/
	...
	$(document).ready(function () {
		...
		*===================================*/
		...
		$('ul.woocommerce-widget-layered-nav-list li a[href*="color"]').each(function() {
			$(this).closest('ul').addClass("color-attribute");
			$('ul.woocommerce-widget-layered-nav-list li a').each(function () {
				if ($(this).text() == 'green') {
					...
					$(this).closest( "li" ).css('background-color', 'blue');
				} else if ($(this).text() == 'orange'){
					$(this).closest( "li" ).css('background-color', 'orange');
				} else if ($(this).text() == 'pink'){
					$(this).closest( "li" ).css('background-color', 'pink');
				} else if ($(this).text() == 'purple'){
					$(this).closest( "li" ).css('background-color', 'purple');
				} else if ($(this).text() == 'brown'){
					$(this).closest( "li" ).css('background-color', 'brown');
				} else if ($(this).text() == 'grey'){
					$(this).closest( "li" ).css('background-color', 'grey');
				} else if ($(this).text() == 'silver'){
					$(this).closest( "li" ).css('background-color', 'silver');
				} else if ($(this).text() == 'tortoise'){
					$(this).closest( "li" ).css('background-color', '#ffab00');
				}
			});
		});
